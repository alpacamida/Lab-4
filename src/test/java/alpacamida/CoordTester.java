...
/* 	(assumes junit.jar is located in /usr/share/java)
 *
 * How to Compile: 
 * 	javac -cp '.:/usr/share/java/*' CoordTester.java 
 * How to Run: 
 * 	java -cp '.:/usr/share/java/*' junit.textui.TestRunner CoordTester
 *
*/

/**
 * A Unit Tester for alpacamida.Coord
 *
 * @author Philip Papadopoulos
 */
public class CoordTester extends TestCase {
    ...
    public void testDiff() {
        ...
        Systen.out.println(NWQuad.diff(origin));
