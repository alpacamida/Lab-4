...
public class GraphicsGrid extends JPanel implements ComponentListener {
    ...
    /**
     * Remove  alpacamida.GridObject
     *
     * @param gobj alpacamida.GridObject to remove from canvas
    ...
    /**
     * Add an alpacamida.GridObject to be drawn. Will only
     * add the same reference once
     *
     * @param gobj alpacamida.GridObject to add for painting
     */
